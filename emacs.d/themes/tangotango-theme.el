...
;; `(default                              ((t (:family "DejaVu Sans Mono" :foundry "unknown" :width normal :height 90 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#eeeeec" :background "#2e3434" :stipple nil :inherit nil))))
 `(default                              ((t (:family "DejaVu Sans Mono" :foundry "unknown" :width normal :height 90 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#eeeeec" :background "black" :stipple nil :inherit nil))))
;; `(cursor                             ((t (:foreground "#222222" :background "#fce94f")))) 
 `(cursor                               ((t (:foreground "#222222" :background "#66cd00")))) 
 ...
 `(magit-item-highlight                 ((t (:weight extra-bold :background "#2b2b2b"))))
 ...
 `(rpm-spec-var-face                    ((t (:foreground "tomato"))))
 `(flycheck-error-face                  ((t (:foreground "white" :background "firebrick"   :weight bold :underline t))))
 `(flycheck-warning-face                ((t (:foreground "white" :background "DarkOrange1" :weight bold :underline t))))
 `(web-mode-doctype-face                ((t (:foreground "#82AE46")))) ; doctype
 `(web-mode-html-tag-face               ((t (:foreground "#E6B422" :weight bold)))) ; 要素名
 `(web-mode-html-attr-name-face         ((t (:foreground "#C97586")))) ; 属性名など
 `(web-mode-html-attr-value-face        ((t (:foreground "#82AE46")))) ; 属性値
 `(web-mode-comment-face                ((t (:foreground "#D9333F")))) ; コメント
 `(web-mode-server-comment-face         ((t (:foreground "#D9333F")))) ; コメント
 `(web-mode-css-rule-face               ((t (:foreground "#A0D8EF")))) ; cssのタグ
 `(web-mode-css-pseudo-class-face       ((t (:foreground "#FF7F00")))) ; css 疑似クラス
 `(web-mode-css-at-rule-face            ((t (:foreground "#FF7F00")))) ; cssのタグ
